...
import (
	...
	masterentities "job-portal/api/entities/master"
	//masteritementities "job-portal/api/entities/master/item"
	//masteroperationentities "job-portal/api/entities/master/operation"
	//masterwarehouseentities "job-portal/api/entities/master/warehouse"

	//transactionworkshopentities "job-portal/api/entities/transaction/workshop"
